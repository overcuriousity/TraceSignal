...
export const TOUR_STEPS: TourStep[] = [
  {
    ...
    body: "Everything in Vestigo lives inside a case — one investigation context grouping sources and timelines. Click New Case and give it a name.",
  ...
  },
  {
    ...
    body: "Click Upload Data to add your first source. Vestigo ingests Timesketch-compatible CSV, JSONL, and Parquet files.",
  ...
  },
  {
    ...
    body: "Vestigo is parsing and storing your file in the background — this tray tracks progress. The tour continues automatically once ingestion finishes.",
