"""Tests for the suricata2tracesignal Parquet converter script.
...
def converter():
    spec = importlib.util.spec_from_file_location("suricata2tracesignal", _SCRIPT)
...
class TestSpecParity:
    ...
    def test_output_validates_against_server_spec(self, converter, tmp_path):
        ...
        assert meta.converter_name == "suricata2tracesignal"
