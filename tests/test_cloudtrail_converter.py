"""Tests for the cloudtrail2tracesignal Parquet converter script.
...
def converter():
    spec = importlib.util.spec_from_file_location("cloudtrail2tracesignal", _SCRIPT)
...
class TestSpecParity:
    ...
    def test_output_validates_against_server_spec(self, converter, tmp_path):
        ...
        assert meta.converter_name == "cloudtrail2tracesignal"
