"""Entry point for the Vestigo web server."""
...
def _build_frontend() -> None:
    ...
    as-is. Set VESTIGO_FRONTEND_REBUILD=1 to force a rebuild after frontend
    source changes.
    """
    force = os.environ.get("VESTIGO_FRONTEND_REBUILD", "").lower() in {"1", "true", "yes"}
