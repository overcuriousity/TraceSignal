...
from vestigo.ingestion.files import UploadTooLargeError, copy_and_hash
    ...
    *,
    ...
    try:
        ...
        raise HTTPException(
            status_code=413,
            detail=(
                f"{exc}. Raise VESTIGO_MAX_UPLOAD_BYTES (0 disables the limit) or ingest "
                "the file server-side with 'vestigo ingest', which avoids the HTTP "
