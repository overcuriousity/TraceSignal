...
from vestigo.models.event import EmbeddingConfig
...
class EmbeddingModel:
    ...
    def load(self) -> SentenceTransformer:
        ...
        Unless ``VESTIGO_ALLOW_ONLINE`` is set, the HuggingFace hub is forced into
        ...
        if self._model is None:
            try:
                ...
                raise RuntimeError(
                    ...
                    "VESTIGO_EMBEDDING_API_BASE_URL to use a remote embedding endpoint."
                ) from exc
            ...
            try:
                ...
                try:
                    ...
                    raise RuntimeError(
                        ...
                        "VESTIGO_ALLOW_ONLINE is disabled. Pre-cache the model weights on this "
                        "machine (see the airgapped install docs) or set VESTIGO_ALLOW_ONLINE=true."
                    ) from exc
            finally:
