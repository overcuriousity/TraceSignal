...
from vestigo.db.postgres import EnrichmentJobRun, PostgresStore
from vestigo.enrichers.base import FIELD_KEY_SEPARATOR, Enricher, derived_field_key
...
async def run_enrichment_job(
    ...
    # (VESTIGO_ENRICHMENT_BATCH_SIZE, default 20k) to keep HTTP round-trip overhead
