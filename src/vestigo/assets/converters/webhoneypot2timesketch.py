#!/usr/bin/env python3
# webhoneypot2timesketch.py — self-contained converter, vendored from https://github.com/overcuriousity/2timesketch
# Upstream commit: 920767a58e290d3626544005cd3261548515307f
...
#
# DShield webhoneypot (isc-agent) HTTP request logs to Timesketch timeline, incl. reverse-proxy X-Forwarded-For/X-Real-Ip client resolution and matched signature metadata.
# Requires only the Python 3.10+ standard library.

from __future__ import annotations

__version__ = "1.0.0+vendored.920767a58e29"
