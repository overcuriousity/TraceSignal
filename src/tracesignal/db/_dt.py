...
# buckets over `timestamp` must exclude sentinel rows via TS_NOT_SENTINEL_SQL,
...
TS_SENTINEL_SQL = f"fromUnixTimestamp64Milli({_NULL_TS_SENTINEL_EPOCH_MS})"
TS_NOT_SENTINEL_SQL = f"timestamp != {TS_SENTINEL_SQL}"
